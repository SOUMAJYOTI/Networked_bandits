...
def gs_bandit_phases(u_b, u_l, c, q, lambda_1, lambda_2, preference_borrowers, preference_lenders):
    ...
    for s_idx in range(NUM_SIMS_PER_STEP):
        ...
        for t in range(1, T + 1):
            ...
            p = 0
            while len(lenders_unmatched) and len(borrowers_unmatched) and p < 20:
                # print("phase ", p)
                p += 1
                ...
                for l_idx in lenders_unmatched:
                    ...
                    if l_idx in lender_matches:
                        ...
                        if c_curr[b_match] <= 0:
                            ...
                            borrowers_to_remove.append(b_match)
                            for l_to_remove in borrower_matches[b_match]:
                                lenders_to_remove.append(l_to_remove)
